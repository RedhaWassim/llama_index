...
def test_complete(mock_post):
            ...
            "messages": [
                {
                    ...
                    "content": [
                        {
                            "type": "text",
                            "content": {"text": "is there a lizard in the image?"},
                        }
                    ],
                },
                {
                    ...
                    "content": [
                        {
                            "type": "text",
                            "content": {
                                "text": "Yes, there is a lizard in the image..."
                            },
                        }
                    ],
                },
    ...
    response = llm.complete(
        prompt="is there a lizard in the image?", image_documents=[image_doc]
    )

    assert (
        response.text
        == "Yes, there is a lizard in the image.  It appears to be a type of agama lizard..."
    )
            ...
            "messages": [
                ...
                },
                {
                    ...
                    "content": [
                        {
                            "type": "text",
                            "content": {"text": "This is an image of a cat."},
                        }
                    ],
                },
            ],
